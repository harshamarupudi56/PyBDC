...
class Main_Window():
    ...
    def __init__(self, master):     
        ...
        self.input_label.grid(row=3, column=0, pady=4, padx=4, sticky=W)
        self.air_KERMA_units_combo.grid(row=3, column=1, pady=5, padx=13, sticky=W)
        self.air_KERMA_output_label.grid(row=4, column=0, pady=5, padx=4, sticky=W)
        self.output_units.grid(row=4, column=1, pady=5, padx=13, sticky=W)
        self.graph_spectra.grid(row=5,column=0, pady=5, columnspan=2)
